...
urmată de caracterul linie nouă (tasta Enter).
Date de ieșire:
Lista efectivă de instrucțiuni pe care trebuie să o execute robotul, după efectuarea
instrucțiunilor de ștergere, omitând instrucțiunea de execuție, fiecare urmată de
caracterul linie nouă (tasta Enter)
